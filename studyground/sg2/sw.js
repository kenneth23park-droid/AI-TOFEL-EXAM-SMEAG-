...
// v82: 시험 런타임의 색도 나머지와 한 갈래로 선다. 상단바·Hide Time·RESPONSE TIME
//      의 연보라(--exam-*)는 녹화 프레임에서 뜬 관찰값이었다 — 배치와 명암 대비는
//      건드리지 않고 색조만 브랜드(블루그린)를 따라가게 했다(상단바의 흰 글자 대비
...
// v109: SET 2 가 저장소에 들어왔다(tools/build_set2.mjs · assets/set2.js). 세트는 부족해도
