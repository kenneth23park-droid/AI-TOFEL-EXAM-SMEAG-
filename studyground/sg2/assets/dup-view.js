...
(function (root, factory) {
  ...
  var CSS = [
    ...
    '.dupv .tagx.high{background:#f7d3cb;color:#a8331a}',
    '.dupv .tagx.watch{background:#faeec4;color:#8a6212}',
    '.dupv .tagx.info{background:var(--cream-2);color:var(--muted)}',
    '.dupv .tagx.same{background:var(--cream-2);color:var(--muted)}',
    ...
    '.dupv .reasons{margin:0 0 13px;padding:10px 12px;background:var(--cream-2);border-radius:9px}',
    ...
    '.dupv .metrics span{font-size:11px;font-weight:750;color:var(--muted);background:var(--cream-2);',
    ...
    '.dupv .side .ans{margin-top:9px;font-size:12px;font-weight:750;color:var(--brand-ink,#a8331a)}',
