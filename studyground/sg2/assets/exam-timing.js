...
(function () {
  ...
  var FALLBACK = {
    ...
    "sections": {
      ...
      "reading": {
        ...
        "sectionSec": 2100,
        "modules": [
          {"id": "R1", "contentRef": "reading.modules[id=R1]", "taskType": null, "allocatedSec": 1080, "perQuestionSec": null, "onExpire": "autoAdvance", "moduleEndScreen": "moduleEnd.reading", "introAudioSelfPaced": null},
          {"id": "R2", "contentRef": "reading.modules[id=R2]", "taskType": null, "allocatedSec": 1020, "perQuestionSec": null, "onExpire": "autoAdvance", "moduleEndScreen": "moduleEnd.reading", "introAudioSelfPaced": null}
        ],
        "tasks": null,
        "taskTypes": null,
        "fallbackPerQuestionSec": null,
    ...
    "directions": [
      ...
      {"id": "moduleEnd.listening", "label": "End of Module", "screenType": "moduleEnd", "insertAt": {"position": "betweenModules", "section": "listening", "module": null}, "maxSec": 30, "advance": "manual", "controls": ["continue"]},
      ...
      {"id": "moduleEnd.reading", "label": "End of Module 1", "screenType": "moduleEnd", "insertAt": {"position": "betweenModules", "section": "reading", "module": "R1"}, "maxSec": 30, "advance": "manual", "controls": ["continue"]},
      ...
      {"id": "taskEnd.writing", "label": "End of Task", "screenType": "moduleEnd", "insertAt": {"position": "betweenModules", "section": "writing", "module": null}, "maxSec": 30, "advance": "manual", "controls": ["continue"]},
  ...
  function builtinFor(profile) {
    // 내장 사본은 TOEFL 하나뿐이다. 다른 프로파일이면 구조가 같은 TOEFL 값으로 degrade 하고 경고한다.
    if (profile !== DEFAULT_PROFILE) {
      return { cfg: FALLBACK, warnings: ['no builtin fallback for profile "' + profile + '"; using ' + DEFAULT_PROFILE] };
    }
    return { cfg: FALLBACK, warnings: [] };
  }
  ...
  function load(profile, cb) {
    ...
    if (isObj(window.SG_TIMING_OVERRIDE)) {
      ...
      if (!vo.fatal) { settle(window.SG_TIMING_OVERRIDE, 'override', prof, vo.warnings); return; }
    ...
    var fell = function (why) {
      ...
      settle(b.cfg, 'builtin', prof, b.warnings.concat([why]));
    };
    ...
    try {
      window.fetch('config/timing.' + prof + '.json', { cache: 'force-cache' })
        ...
        .then(function (json) {
          ...
          settle(json, 'fetch', prof, v.warnings);
        })
